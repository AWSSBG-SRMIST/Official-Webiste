      ...
      <div className="about-container">
        <div className="about-col-text">
          <div className="about-block">
            ...
            <p className="para">
              AWS Student Builder Group - SRMIST is a student-led community for
              builders exploring the intersection of cloud computing, software
              development, AI/ML, and DevOps within the AWS ecosystem. Through
              hands-on workshops, real-world projects, and technical sessions,
              we enable students to learn, build, and deploy modern cloud-native
              systems. Our focus is simple: turn curious students into capable
              builders by giving them the environment, tools, and community to
          ...
          <div className="about-block" style={{ marginTop: "32px" }}>
            ...
            <p className="para">
              We organise hands-on workshops on AWS services, certification
              bootcamps for AWS Cloud Practitioner and beyond, industry speaker
              sessions, hackathons, and networking events — all designed to
